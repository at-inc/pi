...
```bash
npm uninstall -g @at-inc/pi
```

For pnpm, Yarn, or Bun installs, use the matching global remove command: `pnpm remove -g @at-inc/pi`, `yarn global remove @at-inc/pi`, or `bun uninstall -g @at-inc/pi`.
