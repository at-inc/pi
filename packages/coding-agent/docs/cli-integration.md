...
For Node.js or TypeScript integrations, prefer `RpcClient` from `@at-inc/pi`. It starts a Pi RPC child process, correlates requests, exposes typed command methods, and delivers session events to listeners.
