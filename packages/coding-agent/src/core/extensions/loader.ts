...
import * as _bundledPiAgentCore from "@at-inc/pi-agent-core";
import type { Provider } from "@at-inc/pi-ai";
import * as _bundledPiAiCompat from "@at-inc/pi-ai/compat";
import * as _bundledPiAiOauth from "@at-inc/pi-ai/oauth";
import * as _bundledPiAiProviders from "@at-inc/pi-ai/providers/all";
...
// avoiding a circular dependency. Extensions can import from @at-inc/pi.
...
const VIRTUAL_MODULES: Record<string, unknown> = {
	...
	"@at-inc/pi-agent-core": _bundledPiAgentCore,
	"@earendil-works/pi-tui": _bundledPiTui,
	// Extensions resolve the pi-ai root to the compat entrypoint (a strict
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	"@at-inc/pi-ai": _bundledPiAiCompat,
	"@at-inc/pi-ai/compat": _bundledPiAiCompat,
	"@at-inc/pi-ai/oauth": _bundledPiAiOauth,
	"@at-inc/pi-ai/providers/all": _bundledPiAiProviders,
	"@at-inc/pi": _bundledPiCodingAgent,
...
function getAliases(): Record<string, string> {
	...
	const piAgentCoreEntry = resolveWorkspaceOrImport("agent/dist/index.js", "@at-inc/pi-agent-core");
	const piTuiEntry = resolveWorkspaceOrImport("tui/dist/index.js", "@earendil-works/pi-tui");
	// Extensions resolve the pi-ai root to the compat entrypoint (a strict
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	const piAiCompatEntry = resolveWorkspaceOrImport("ai/dist/compat.js", "@at-inc/pi-ai/compat");
	const piAiOauthEntry = resolveWorkspaceOrImport("ai/dist/oauth.js", "@at-inc/pi-ai/oauth");
	const piAiProvidersEntry = resolveWorkspaceOrImport("ai/dist/providers/all.js", "@at-inc/pi-ai/providers/all");

	_aliases = {
		"@at-inc/pi": piCodingAgentEntry,
		"@at-inc/pi-agent-core": piAgentCoreEntry,
		"@earendil-works/pi-tui": piTuiEntry,
		"@at-inc/pi-ai/providers/all": piAiProvidersEntry,
		"@at-inc/pi-ai/compat": piAiCompatEntry,
		"@at-inc/pi-ai/oauth": piAiOauthEntry,
		"@at-inc/pi-ai": piAiCompatEntry,
