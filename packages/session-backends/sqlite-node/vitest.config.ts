...
export default defineConfig({
	...
	resolve: {
		...
		alias: [
			...
			{ find: /^@at-inc\/pi-agent-core\/node$/, replacement: agentNode },
			{ find: /^@at-inc\/pi-agent-core\/harness\/session\/testing$/, replacement: agentSessionTesting },
			{ find: /^@at-inc\/pi-agent-core$/, replacement: agentIndex },
			{ find: /^@at-inc\/pi-ai$/, replacement: aiIndex },
		],
	},
