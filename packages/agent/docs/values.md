...
`AssistantMessageFrame`, `AssistantMessageFrameEncoder`, and `reduceAssistantMessageFrames()` come from `@at-inc/pi-ai`. Do not define a second frame codec or reducer.
